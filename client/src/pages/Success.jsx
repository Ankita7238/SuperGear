...
import { useSelector, useDispatch } from "react-redux"; // Import from Redux Toolkit
...
import { resetCart } from "../lib/storeSlice"; // Import resetCart action

const Success = () => {
  const dispatch = useDispatch();
  const currentUser = useSelector((state) => state.store.currentUser); // Get currentUser from Redux store
  const cartProduct = useSelector((state) => state.store.cartProduct); // Get cartProduct from Redux store
  ...
  }, [navigate, currentUser, cartProduct, dispatch]);
