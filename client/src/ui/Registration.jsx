  ...
  return (
    <div>
      {login ? (
        ...
        <div className="bg-red-900 max-w-3xl mx-auto rounded-lg">
          <form
            onSubmit={handleRegistration}
            className="max-w-2xl mx-auto pt-20 px-10 lg:px-0 text-white"
          >
                    ...
                    <div className="flex-1">
                      ...
                      <div className="mt-2 flex justify-center rounded-lg border border-dashed border-white/25 px-6 py-4">
                        <div className="flex flex-col items-center text-center">
                          <div className="w-14 h-14 border border-gray-300 rounded-full p-2">
                            {avatar?.url ? (
                              <img
                                src={avatar.url}
                                alt="userImage"
                              ...
                              <MdPhotoLibrary className="mx-auto h-full w-full text-gray-300" />
                            )}
                          </div>
                          <div className="mt-4 flex items-center mb-1 text-sm leading-6 text-gray-400">
                            <label htmlFor="file-upload">
                              <span className="relative cursor-pointer rounded-md px-2 py-1 font-semibold text-gray-200 hover:bg-gray-800">
                                Upload a file
                              </span>
                              <input
                                type="file"
            ...
            {errMsg && (
              <p className="bg-white/90 text-black text-center py-1 rounded-md tracking-wide font-semibold">
                {errMsg}
              </p>
            )}
            <button
              disabled={loading}
              type="submit"
              className={`mt-5 w-full py-2 uppercase text-base font-bold tracking-wide text-gray-300 rounded-md hover:text-white hover:bg-gray-800 duration-200 ${
                loading ? "bg-gray-500 hover:bg-gray-500" : " bg-gray-900"
              }`}
            >
